...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://istanbulcafecincy.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      ...
				      <li>
				        <img src="img/slider-images/Screenshot_6.png" alt="">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#contactform" data-transition="<?php echo $transitionefect ?>"><img src="img/mail.png"></a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Menu</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Reviews</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                ...
                <h2>Authentic Turkish & Mediterranean Cuisine</h2>
                    <p>Reserve your table now call us</p>
